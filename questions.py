...
QUESTIONS = [
    {"question": "what is the withdrawal policy?", "expects": "Withdrawal runs until week ten and requires an adviser signature. It results in a W on your transcript, which does not affect your GPA."},
