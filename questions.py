...
QUESTIONS = [
    {"question": "what are the work load for ECON 101?", "expects": "4 hours a week "},
    {"question": "what is the withdrawal policy?", "expects": "week ten"},
    {"question": "how many times can you change the meal plan?", "expects": "once"},
    {"question": "what is the workload on ECON 101 Introduction to Economics?", "expects": "4 hours a week outside class"},
    {"question": "what is the average class size for ECON 101?", "expects": "300 people"},
]
